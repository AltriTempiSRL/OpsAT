...
vuelta en esa carpeta, **nunca en el proyecto**. La guía global de Codex también lo indica en
`~/.codex/AGENTS.md`.

Roster:
- **Mark** — CSS/UI, QA funcional, UX, diseño visual; decisión explícita de salida a producción.
- **Pit** — gerente de operaciones (WWP en vivo, cuellos de botella, KPIs, Odoo). Análisis, no ejecuta.
